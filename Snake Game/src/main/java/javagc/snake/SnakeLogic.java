...
public class SnakeLogic {
	...
	private final double coreSpeed = 1./8; // speed in pixels, 100 must be divisible by coreSpeed*100, otherwise the snake will desintgerate on turning and coming back together...
	private int animSpeedFactor = 1;
	private AtomicBoolean reactionNeeded;

	// holds the key bindings for up, down, left, right;
	...
	// EventHandler für KeyInput
	final EventHandler<KeyEvent> keyHandler;
	//private SnakeCollisionHandler collisionHandler;
